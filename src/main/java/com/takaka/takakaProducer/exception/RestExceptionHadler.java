...
public class RestExceptionHadler {
	...
	@ExceptionHandler(value = ResposeBusinessException.class)
	@ResponseStatus(value = HttpStatus.BAD_REQUEST)
	public ResponseException badRequestException(HttpServletRequest request, ResposeBusinessException exception) {
